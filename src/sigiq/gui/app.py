...
from sigiq.core.io.iq_reader import read_iq
from sigiq.core.io.wav_reader import read_wav
from sigiq.core.io.metadata_parser import parse_metadata
from sigiq.core.pipeline.pipeline_config import PipelineConfig
from sigiq.core.pipeline.analyzer import run_pipeline
from sigiq.core.hypotheses.modulation_candidates import CANDIDATE_REGISTRY
from sigiq.core.hypotheses.fec_candidates import FEC_CANDIDATES
from sigiq.core.hypotheses.interleaving_candidates import INTERLEAVING_CANDIDATES
from sigiq.core.correlation.payload_detection import bits_to_hex

from sigiq.gui.style import apply_theme, MUTED, TEXT, GOOD, BAD, ACCENT
from sigiq.gui.plots import WaveformWaterfallPlots, SpectrumPlot, ConstellationPlot
...
class SignalAnalysisApp(tk.Tk):
    def __init__(self):
        ...
        try:
            ...
            icon_img = Image.open(os.path.join(os.path.dirname(__file__), "..", "assets", "icon.png"))
